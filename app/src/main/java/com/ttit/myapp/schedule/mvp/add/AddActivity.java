...
import com.ttit.myapp.schedule.custom.EditTextLayout;
...
import com.ttit.myapp.schedule.utils.spec.PopupWindowDialog;
...
public class AddActivity extends BaseActivity implements AddContract.View, View.OnClickListener {
    ...
    private void initView() {
        ...
        mIvSubmit.setImageResource(R.drawable.ic_add_black_24dp);
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (obj != null) {
                ...
                if (mAddMode || courseV2.getCouId() == null) {
                    ...
                    courseV2.init();
                    if (Cache.instance().getCourseV2Dao() == null) {
