...
import com.ttit.myapp.util.LogUtil;
...
public class CourseView extends FrameLayout {
    ...
    public com.ttit.myapp.schedule.custom.course.CourseView setRowCount(int rowCount) {
        mRowCount = rowCount;
        return this;
    }
    ...
    public com.ttit.myapp.schedule.custom.course.CourseView setColCount(int colCount) {
        mColCount = colCount;
        return this;
    }
    ...
    public  com.ttit.myapp.schedule.custom.course.CourseView setRowItemWidth(int rowItemWidth) {
    ...
    public  com.ttit.myapp.schedule.custom.course.CourseView setColItemHeight(int colItemHeight) {
    ...
    public  com.ttit.myapp.schedule.custom.course.CourseView setCurrentIndex(int currentIndex) {
    ...
    public  com.ttit.myapp.schedule.custom.course.CourseView setRowItemWidthAuto(boolean rowItemWidthAuto) {
    ...
    public  com.ttit.myapp.schedule.custom.course.CourseView setCourseItemRadius(float courseItemRadius) {
    ...
    public  com.ttit.myapp.schedule.custom.course.CourseView setShowVerticalLine(boolean showVerticalLine) {
    ...
    public  com.ttit.myapp.schedule.custom.course.CourseView setShowHorizontalLine(boolean showHorizontalLine) {
    ...
    public  com.ttit.myapp.schedule.custom.course.CourseView setTextLRPadding(int textLRPadding, int textTBPadding) {
    ...
    public  com.ttit.myapp.schedule.custom.course.CourseView setTextColor(int textColor) {
    ...
    public  com.ttit.myapp.schedule.custom.course.CourseView setInactiveBackgroundColor(int inactiveBackgroundColor) {
        mInactiveBackgroundColor = inactiveBackgroundColor;
        return this;
    }

    public  com.ttit.myapp.schedule.custom.course.CourseView setTextTBMargin(int textTBMargin, int textLRMargin) {
    ...
    public  com.ttit.myapp.schedule.custom.course.CourseView setTextSize(int textSize) {
        mTextSize = textSize;
        return this;
    }
}
