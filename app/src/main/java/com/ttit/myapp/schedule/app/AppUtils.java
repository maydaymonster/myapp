...
import com.ttit.myapp.schedule.data.bean.Course;
import com.ttit.myapp.schedule.data.bean.CsItem;
import com.ttit.myapp.schedule.data.beanv2.CourseGroup;
import com.ttit.myapp.schedule.data.beanv2.CourseV2;
import com.ttit.myapp.schedule.data.db.CourseDbDao;
import com.ttit.myapp.schedule.data.greendao.CourseGroupDao;
import com.ttit.myapp.schedule.data.greendao.CourseV2Dao;
import com.ttit.myapp.schedule.data.greendao.DaoMaster;
import com.ttit.myapp.schedule.data.greendao.DaoSession;
import com.ttit.myapp.schedule.data.greendao.MyOpenHelper;
...
import com.ttit.myapp.schedule.widget.UpdateJobService;
...
public class AppUtils {
    ...
    public static String getGravatar(String email) {
        String emailMd5 = com.ttit.myapp.schedule.app.AppUtils.md5Hex(email);        //设置图片大小32px
    ...
    public static void startWidgetJobService(Context context) {
        if (!isJobPollServiceOn(context)) {
            LogUtil.i(com.ttit.myapp.schedule.app.AppUtils.class, "安排widget更新任务");
            ...
            LogUtil.i(com.ttit.myapp.schedule.app.AppUtils.class, "widget更新任务已经安排");
        }
    }
    ...
    public static void cancelUpdateWidgetService(Context context) {
        LogUtil.e(com.ttit.myapp.schedule.app.AppUtils.class, "cancelUpdateWidgetService");
        JobScheduler scheduler = (JobScheduler) context
                .getSystemService(Context.JOB_SCHEDULER_SERVICE);
