...
public class MyWidget extends AppWidgetProvider {
    ...
    private void updateAction(Context context) {
        ...
        int[] appWidgetId = appWidgetManager.getAppWidgetIds(new ComponentName(context, com.ttit.myapp.schedule.widget.MyWidget.class));

        thisWidget = new ComponentName(context,com.ttit.myapp.schedule.widget.MyWidget.class);
        ...
        Intent intent1 = new Intent(context, NewsFragment.class);
