...
import com.ttit.myapp.schedule.utils.ColorUtil;

import java.util.ArrayList;
import java.util.List;
public class WheelView extends ScrollView {
    public static final String TAG = com.ttit.myapp.schedule.custom.WheelView.class.getSimpleName();
...
//                    Log.d(TAG, "remainder: " + remainder + ", divided: " + divided);
                    if (remainder == 0) {
                        ...
                        if (remainder > itemHeight / 2) {
                            com.ttit.myapp.schedule.custom.WheelView.this.post(new Runnable() {
                                @Override
                                public void run() {
                                    com.ttit.myapp.schedule.custom.WheelView.this.smoothScrollTo(0, initialY - remainder + itemHeight);
                            ...
                            com.ttit.myapp.schedule.custom.WheelView.this.post(new Runnable() {
                                @Override
                                public void run() {
                                    com.ttit.myapp.schedule.custom.WheelView.this.smoothScrollTo(0, initialY - remainder);
                                    selectedIndex = divided + offset;
                                    onSeletedCallBack();
                                }
                            });
                    ...
                    initialY = getScrollY();
                    com.ttit.myapp.schedule.custom.WheelView.this.postDelayed(scrollerTask, newCheck);
                }
            }
        };
...
//            position = divided + offset + 1;
    ...
    public void setSeletion(int position) {
        ...
        this.post(new Runnable() {
            @Override
            public void run() {
                com.ttit.myapp.schedule.custom.WheelView.this.smoothScrollTo(0, p * itemHeight);
                onSeletedCallBack();
            }
        });
    }
