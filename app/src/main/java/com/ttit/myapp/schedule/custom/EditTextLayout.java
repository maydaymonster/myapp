...
public class EditTextLayout extends LinearLayout {
     ...
     */
    public com.ttit.myapp.schedule.custom.EditTextLayout setInputType(int inputType) {
        mEtText.setInputType(inputType);
        return this;
    }

    public com.ttit.myapp.schedule.custom.EditTextLayout setInputEnabled(boolean enabled) {
        mEtText.setFocusable(enabled);
        return this;
    }

    public com.ttit.myapp.schedule.custom.EditTextLayout setHint(String hint) {
        mHint = hint;
        mEtText.setHint(hint);
        return this;
    }

    public com.ttit.myapp.schedule.custom.EditTextLayout setText(String text) {
    ...
    public com.ttit.myapp.schedule.custom.EditTextLayout setIcon(Drawable icon) {
        if (icon != null) {
    ...
    public void setOnClickListener(@Nullable final View.OnClickListener l) {
        ...
        mEtText.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (l != null) {
                    l.onClick(com.ttit.myapp.schedule.custom.EditTextLayout.this);
                }
            }
        });
    }
    ...
    public com.ttit.myapp.schedule.custom.EditTextLayout setCloseListener(CloseListener closeListener) {
